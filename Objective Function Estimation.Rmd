...
#GFC Dummy
data$Dates <- strptime(as.character(data$Dates), "%Y-%m-%d") # correct date format
...
# Moody’s seasoned BAA corporate bond yield relative to yield on 10-year Treasury constant maturity, obtained from FRED; end of month value
...
lr_inf_infsq_gdp_gdpsq <- lapply(1:n,function(x) lm_robust(netneg ~ inf_f_x_dataframe[,x]+inf_f_xsq_dataframe[,x] + gdp_f_x_dataframe[,x]+gdp_f_x_dataframe[,x] + phillowe, se_type = 'stata'))
...
lr_uncertainty_usffr_ur <- lm_robust(netneg ~ inf_f_02 +inf_f_02sq + ur_f_02  + phillowe + ntwiqg +  us_ffr + uncertainty + rppiqg + aus_bbb, se_type = 'stata')

lr_uncertainty_usffr_ursq <- lm_robust(netneg ~ inf_f_02 +inf_f_02sq + ur_f_02 + ur_f_02sq  + phillowe+ ntwiqg +  us_ffr + uncertainty + rppiqg+ aus_bbb, se_type = 'stata')

lr_uncertainty_usffr_urinc <- lm_robust(netneg ~ inf_f_02 +inf_f_02sq + ur_f_02 + ur_f_02_inc  +  phillowe+ ntwiqg +  us_ffr + uncertainty + rppiqg+ aus_bbb, se_type = 'stata')

lr_uncertainty_usffr_ur_gdp <- lm_robust(netneg ~ inf_f_02 +inf_f_02sq + ur_f_02 + gdp_f_02  + phillowe+ ntwiqg +  us_ffr + uncertainty + rppiqg+ aus_bbb, se_type = 'stata')

lr_uncertainty_usffr_ursq_gdp <- lm_robust(netneg ~ inf_f_02 +inf_f_02sq + ur_f_02 + ur_f_02sq  + gdp_f_02 + phillowe+ ntwiqg +  us_ffr + uncertainty + rppiqg+ aus_bbb, se_type = 'stata')

lr_uncertainty_usffr_urinc_gdp <- lm_robust(netneg ~ inf_f_02 +inf_f_02sq + ur_f_02 + ur_f_02_inc + gdp_f_02  +  phillowe+ ntwiqg +  us_ffr + uncertainty + rppiqg+ aus_bbb, se_type = 'stata')

lr_uncertainty_usffr_gdp <- lm_robust(netneg ~ inf_f_02 +inf_f_02sq + gdp_f_02 + phillowe+ ntwiqg +  us_ffr + uncertainty + rppiqg+ aus_bbb, se_type = 'stata')

lr_uncertainty_usffr_gdp_gdpsq <- lm_robust(netneg ~ inf_f_02 +inf_f_02sq + gdp_f_02 + gdp_f_02sq +  phillowe+ ntwiqg +  us_ffr + uncertainty + rppiqg+ aus_bbb, se_type = 'stata')

lr_uncertainty_usffr_gdp_gdpsq_ur <- lm_robust(netneg ~ inf_f_02 +inf_f_02sq + gdp_f_02 + gdp_f_02sq + ur_f_02+  phillowe+ ntwiqg +  us_ffr + uncertainty + rppiqg+ aus_bbb, se_type = 'stata')
