...
rppi <- data$`Residential Property Price Index ;  Weighted average of eight capital cities ;`
rppiyeg <- data$RPPIYEG

ehpi <- data$`Established House Price Index ;  Weighted average of eight capital cities ;`
ehpiyeg <- data$EHPIYEG

adpy <- data$`Attached Dwellings Price Index ;  Weighted average of eight capital cities ;`
adpyeg <- data$ADPYEG
```
